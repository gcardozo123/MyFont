...
uint8_t RST, uint8_t MISO);
  ...
  void begin(void),
           ...
           fillScreenPozzer(uint16_t color),
...
*/
  ...
  void printTextPozzer(int16_t x, int16_t y, int16_t w, int16_t h, unsigned char *str);
  void printCompactTextGuilherme(int16_t x, int16_t y, int16_t w, int16_t h, unsigned char *str,uint8_t strSize);
